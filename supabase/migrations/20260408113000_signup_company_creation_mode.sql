-- Respect signup company creation mode for invited admins:
-- create a company/subscription only when company_creation_mode = 'create'.
-- Accountant firm invitations still force cabinet creation/linking.
