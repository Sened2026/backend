-- Reserve paid subscription ownership to merchant_admin.
-- Accountant owners get a technical free subscription row so guards keep working,
-- but they never need Stripe checkout at signup.
...
VALUES (
    ...
    1,
    100,
    '{"pdf_export": true, "email_support": false}'::jsonb,
    false,
    0
)
...
SET
    ...
    is_active = false,
    price_per_additional_member = EXCLUDED.price_per_additional_member;
