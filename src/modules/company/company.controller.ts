...
export class CompanyController {
    ...
    async searchMerchants(
        ...
        @Query('q') query: string,
    ): Promise<{ id: string; name: string; legal_name: string | null; siren: string | null; city: string | null; logo_url: string | null }[]> {
    ...
    async linkAccountant(
        ...
        return this.companyService.linkAccountant(userId, id, dto.accountant_company_id);
    }
    ...
    async getAccountantLinkRequests(
        ...
        return this.companyService.getAccountantLinkRequests(userId, id, query.direction || 'incoming');
    }
    ...
    async createAccountantLinkRequest(
        ...
        return this.companyService.createAccountantLinkRequest(userId, id, dto.merchant_company_id);
    }
    ...
    async acceptAccountantLinkRequest(
        ...
        return this.companyService.acceptAccountantLinkRequest(userId, id, requestId);
    }
    ...
    async rejectAccountantLinkRequest(
        ...
        return this.companyService.rejectAccountantLinkRequest(userId, id, requestId);
    }
    ...
    async getLinkedClientDocuments(
        ...
        return this.companyService.getLinkedClientDocuments(userId, id, clientId, query);
    }
    ...
    async inviteMember(
        ...
        return this.companyService.inviteMember(userId, id, dto.email, dto.role as any, inviterEmail);
    }
