...
describe('NotificationService email rendering', () => {
    ...
    beforeEach(() => {
        ...
        service = new NotificationService(configService as unknown as ConfigService);
    ...
    it('renders SENED fallback only in invite emails without a company logo', async () => {
        ...
        expect(sentEmail?.html).not.toContain('class="header-logo-cell header-company-logo-cell"');
